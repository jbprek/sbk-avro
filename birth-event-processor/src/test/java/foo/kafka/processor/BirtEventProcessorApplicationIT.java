...
@SpringBootTest(classes = BirtEventProcessorApplication.class, properties = {
...
@DirtiesContext
class BirtEventProcessorApplicationIT {
    ...
    void testBirthEventProcessing() {
        ...
        ConsumerRecords<String, BirthStatEntry> records = consumer.poll(Duration.ofMillis(2000));
        var record = records.iterator().next();
        var birthStatOut = record.value();
